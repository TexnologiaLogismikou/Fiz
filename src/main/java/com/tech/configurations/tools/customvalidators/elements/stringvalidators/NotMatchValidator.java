...
public class NotMatchValidator extends StringValidator implements ICustomValidator,IStringValidator{
    ...
    public NotMatchValidator(String p) {
        super(new ResponseEntity<>(Responses.STRING_INAPPROPRIATE_FORMAT, HttpStatus.NOT_ACCEPTABLE),"NotMatchValidator");
     ...
     * 
     * @param str
     * @return if the regex returns false means that the validation wasn't met and the validate will return false
     */
    @Override
